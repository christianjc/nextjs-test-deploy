...
import { TextField, Select, FormControl, InputLabel, FormHelperText, MenuItem } from '@mui/material'
...
export const SelectInput = ({ label, labelid, id, ...props }: SelectInputProps) => {
